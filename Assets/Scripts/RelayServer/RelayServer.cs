...
{    
    ...
    // Starts a game host with a relay allocation:
    ...
    // Joins a game with relay:
    // it will initialize the Unity services, sign in anonymously,
    // join the relay with the given join code and start the client.
